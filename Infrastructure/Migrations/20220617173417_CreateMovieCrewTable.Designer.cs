...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220617173417_CreateMovieCrewTable")]
    partial class CreateMovieCrewTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieMovieCrew", b =>
                {
                    b.Property<int>("MovieIDId")
                        .HasColumnType("int");

                    b.Property<int>("MovieCrewersMovieId")
                        .HasColumnType("int");

                    b.Property<int>("MovieCrewersCrewId")
                        .HasColumnType("int");

                    b.Property<string>("MovieCrewersDepartment")
                        .HasColumnType("nvarchar(128)");

                    b.Property<string>("MovieCrewersJob")
                        .HasColumnType("nvarchar(128)");

                    b.HasKey("MovieIDId", "MovieCrewersMovieId", "MovieCrewersCrewId", "MovieCrewersDepartment", "MovieCrewersJob");

                    b.HasIndex("MovieCrewersMovieId", "MovieCrewersCrewId", "MovieCrewersDepartment", "MovieCrewersJob");

                    b.ToTable("MovieMovieCrew");
                });
            ...
            modelBuilder.Entity("MovieMovieCrew", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.MovieCrew", null)
                        .WithMany()
                        .HasForeignKey("MovieCrewersMovieId", "MovieCrewersCrewId", "MovieCrewersDepartment", "MovieCrewersJob")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
